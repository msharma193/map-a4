...
public class IntrestedFragment extends Fragment {

    public IntrestedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_intrested, container, false);

        RecyclerView recyclerView = rootView.findViewById(R.id.recyclerViewInterestedBooks);
        ...
        executor.execute(new Runnable() {
            @Override
            public void run() {
                List<SavedBook> interestedBooks = savedBookDao.getIntrestedInBook();

                // Update the UI on the main thread
                requireActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        SavedBooksAdapter adapter = new SavedBooksAdapter(interestedBooks);
        ...
        if (getActivity() != null && ((AppCompatActivity) getActivity()).getSupportActionBar() != null) {
            requireActivity().setTitle("Book I am Interested In");
